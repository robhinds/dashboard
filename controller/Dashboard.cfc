...
component output="false"{
	...
	public void function welcome(myFususebox, event){
		...
		application.widgetService.createGageWidget( myFusebox:myFusebox, event:event, rowNumber:2, colNumber:1, width:1, height:1 , title:'Awesome-ness', bgColour:'blue', apiUrl:'/dashboard/index.cfm/api/examplegage', refreshRate:2000 );
